export const botContentFields = [
  ...
  { key: "support_url", group: "Links and accounts", label: "Telegram support link", kind: "telegram_url", help: "Must look like https://t.me/username", defaultValue: "" },
  { key: "payment_bkash", group: "Links and accounts", label: "bKash number", kind: "phone", help: "Digits only.", defaultValue: "" },
  { key: "payment_nagad", group: "Links and accounts", label: "Nagad number", kind: "phone", help: "Digits only.", defaultValue: "" },
  { key: "payment_upay", group: "Links and accounts", label: "Upay number", kind: "phone", help: "Digits only.", defaultValue: "" },
] as const;
